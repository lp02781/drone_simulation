...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/mfikih15/drone_simulation/src/pid)
  set(pid_DEVEL_PREFIX /home/mfikih15/drone_simulation/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/mfikih15/drone_simulation/install)
...
if(NOT "/home/mfikih15/drone_simulation/devel/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/mfikih15/drone_simulation/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mfikih15/drone_simulation/src/pid/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mfikih15/drone_simulation/devel/lib;/home/mfikih15/laser_beam/devel/lib;/opt/ros/melodic/lib)
